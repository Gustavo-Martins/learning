...
print(
    "O valor da soma dos números é {}, e o da subtração é {}".format(
        addition, subtraction
    )
)
print(
    "O valor da divisão é {:.3f}, o da divisão inteira é {}, e o módulo é {}".format(
        division, floor_division, modulus
    )
)
