...
payment_method = float(input('''Selecione a forma de pagamento: 
...
if payment_method == 1:
    ...
    print('O preço final da compra de R$ {:.2f} será: R$ {:.2f}'.format(subtotal, total))
    ...
    if n_monthly_payments < 3:
        ...
        print('Sua compra será parcelada em {}x de R$ {:.2f} com juros.'.format(n_monthly_payments, monthly_payment_value))
        print('O preço final da sua compra de R$ {:.2f} será: R$ {:.2f}'.format(subtotal, total))
else:
